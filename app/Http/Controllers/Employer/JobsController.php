...
class JobsController extends Controller
{
    ...
    public function saveManageJob(Request $request)
    {
        $request->validate([
            ...
            "job_store.required" => "Please select a store/location. This field is required.",
            "job_store.integer" => "Invalid store selection. Please select a valid store.",
            "job_reference.required" => "Job Reference is required. Please enter a job reference (e.g., OPT-JAN25-001).",
            "job_reference.string" => "Job Reference must be text. Please enter a valid job reference.",
            "job_reference.max" => "Job Reference cannot exceed 255 characters. Please enter a shorter reference.",
            "job_reference.regex" => "Job Reference can only contain letters, numbers, and dashes. Special characters are not allowed.",
            "job_dates.required" => "At least one date is required. Please add a date for the job.",
            "job_dates.array" => "Invalid date format. Please check your date entries.",
            "job_dates.min" => "At least one date is required. Please add a date for the job.",
            "job_dates.*.required" => "Date is required. Please select a date for this entry.",
            "job_dates.*.regex" => "Invalid date format. Please use the format dd/mm/yyyy (e.g., 25/01/2025).",
            "job_start_times.required" => "At least one start time is required. Please enter a start time.",
            "job_start_times.array" => "Invalid start time format. Please check your time entries.",
            "job_start_times.min" => "At least one start time is required. Please enter a start time.",
            "job_start_times.*.required" => "Start time is required. Please enter a start time for this entry.",
            "job_start_times.*.date_format" => "Invalid start time format. Please use the format HH:mm (e.g., 09:00 or 14:30).",
            "job_end_times.required" => "At least one end time is required. Please enter an end time.",
            "job_end_times.array" => "Invalid end time format. Please check your time entries.",
            "job_end_times.min" => "At least one end time is required. Please enter an end time.",
            "job_end_times.*.required" => "End time is required. Please enter an end time for this entry.",
            "job_end_times.*.date_format" => "Invalid end time format. Please use the format HH:mm (e.g., 17:00 or 18:30).",
            "job_rate.required" => "Rate Offered is required. Please enter the rate in pounds (£).",
            "job_rate.numeric" => "Rate Offered must be a number. Please enter a valid rate (e.g., 150 or 175.50).",
            "job_rate.min" => "Rate Offered must be at least £1. Please enter a valid rate.",
            "num_locums_needed.required" => "Number of Locums Needed is required. Please enter how many locums you need.",
            "num_locums_needed.integer" => "Number of Locums Needed must be a whole number. Please enter a valid number.",
            "num_locums_needed.min" => "Number of Locums Needed must be at least 1. Please enter a valid number.",
            "job_date_new.required_if" => "When Preset Rate Increase is enabled, at least one timeline date is required.",
            "job_date_new.array" => "Invalid timeline date format. Please check your timeline entries.",
            "job_date_new.*.required_if" => "Timeline date is required. Please select a date for this rate increase timeline.",
            "job_date_new.*.date_format" => "Invalid timeline date format. Please select a valid date.",
            "job_rate_new.required_if" => "When Preset Rate Increase is enabled, at least one increase rate is required.",
            "job_rate_new.array" => "Invalid increase rate format. Please check your timeline entries.",
            "job_rate_new.*.required_if" => "Increase rate is required. Please enter the rate increase amount for this timeline.",
            "job_rate_new.*.numeric" => "Increase rate must be a number. Please enter a valid amount (e.g., 10 or 25.50).",
            "job_rate_new.*.min" => "Increase rate cannot be negative. Please enter 0 or a positive number.",
            "job_timeline_hrs.*.integer" => "Timeline hours must be a whole number between 1 and 24.",
            "job_timeline_hrs.*.min" => "Timeline hours must be at least 1 hour.",
            "job_timeline_hrs.*.max" => "Timeline hours cannot exceed 24 hours.",
            "job_timeline_time.required_if" => "When Preset Rate Increase is enabled, at least one timeline time is required.",
            "job_timeline_time.array" => "Invalid timeline time format. Please check your timeline entries.",
            "special_requirements_custom.max" => "Special Requirements cannot exceed 1000 characters. Please shorten your text.",
        ]);
